...
public class Newsadapter extends RecyclerView.Adapter<Newsadapter.ViewHolder> {
    ...
    public Newsadapter(List<News> listItems, Context context, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.date.setText("Short by :"+listItem.getWritten()+" . "+listItem.getDate());
        ...
        holder.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "*" + listItem.getTitle().trim()+ "*" + "\n\n"
        ...
        holder.tapdetails.setText("Tap To See More Details About This From "+listItem.getOriginal_article());
...
//        holder.newscard.setAnimation(AnimationUtils.loadAnimation(context,R.anim.fade_transition));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView title, desc, date,tapdetails;
        public View v;
        ImageView newsimg;
        CardView newscard;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tapdetails=itemView.findViewById(R.id.tapdetails);
        }
    }
