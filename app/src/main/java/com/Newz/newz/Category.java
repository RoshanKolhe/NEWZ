...
public class Category {
    ...
    public Category(String id, String title, String short_news, String detail_news, String news_link, String original_article, String category, String photo, String date, String tags) {
        this.id = id;
        this.title = title;
